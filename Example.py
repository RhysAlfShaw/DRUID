...
PATH_image = '~/Documents/R/ADP.2019-02-11T13:02:26.713.fits'
...
findmysources = sf(image=image,image_path=None,mode='optical',area_limit=5,smooth_sigma=1.5,nproc=1,GPU=False)
